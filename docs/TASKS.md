...
- [x] Add presentation-only 15-second automatic rotation across every registered slide, with a 400 ms crossfade, pause during loading/refresh/error states, and a subtle accessible position indicator.
