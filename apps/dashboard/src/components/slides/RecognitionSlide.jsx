...
export function RecognitionSlide({ data }) {
  ...
  return <main className="recognition-slide dashboard-slide" aria-labelledby="recognition-title">
    <header className="top-three-heading"><p>{overallAvailable ? "Overall standing" : "Revenue Rank fallback"}</p><h2 id="recognition-title">{overallAvailable ? "Top 3 Overall" : "Top 3 Revenue Leaders"}</h2><span>Today’s top performers</span></header>
