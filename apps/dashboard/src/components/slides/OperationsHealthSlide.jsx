...
export function OperationsHealthSlide({ data }) {
  return <main className="operations-health dashboard-slide" aria-labelledby="operations-health-title">
    ...
    <section className="panel operations-domain__panel"><div className="panel__heading"><div><p>Daily throughput</p><h3>Calls &amp; Activity</h3></div><span>Billable calls · opportunities · leads · installs</span></div><KpiComparisonChart slide={data.slides.activity} data={data} /></section>
