...
function CustomizePage() {
  return <main className="customization-page"><a className="customization-page__back" href="/remote">← Back to Remote</a><MetricCustomization /></main>;
}
...
export default function App() {
  ...
  if (route.type === "customize") return <CustomizePage />;
