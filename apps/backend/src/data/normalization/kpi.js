...
function metricRecord(kpiId, value, quality) {
  ...
  return {
    id: kpiId,
    label: kpis[kpiId].label,
    shortLabel: kpis[kpiId].shortLabel,
    ...normalized,
    dataQuality: dataQualityFor(normalized.hasData, quality),
    format: kpis[kpiId].format,
    unit: kpis[kpiId].unit
  };
}
